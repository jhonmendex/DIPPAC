...
<head>
    ...
    <title>Prueba de discalculia léxica 1 - 8 años</title>
</head>
    ...
    <div id="background">
        ...
        <div id="operation">
            ...
            <div id="buttons">
                ...
                <div id="finish">
                    <a id="continue" class="btn btn-primary disable-links" href="index.php?controlador=DyscalculiaIndex&accion=Lexical28">Continuar</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function validateAnswer(e) {
        if (e) {
            isCorrect = e.target.innerText == "Multiplicación" ? true : false;
        ...
        var answer3 = {
            ...
            answer: answer,
            image: null,
            testName: "Discalculia Léxica - Prueba 1 - 8 años"
        };
