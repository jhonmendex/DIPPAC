...
<head>
    ...
    <title>Prueba de discalculia gráfica 2 - 6 años</title>
</head>
...
<body>
    <div id="background">
        ...
        <div id="statement">
            <h1>Dibuja el signo de resta:</h1>
        </div>
        ...
        document.querySelectorAll('button.answer').forEach(function(btn) {
            btn.addEventListener('click', function(e) {
                ...
                var answer12 = {
                    type: 0,
                    isCorrect: null,
                    answer: "Dibuja el signo de resta:",
                    image: imagen,
                    testName: "Prueba de discalculia gráfica 2 - 6 años"
                };
