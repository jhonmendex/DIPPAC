...
<head>
    ...
    <title>Prueba de discalculia gráfica 1 - 9 años</title>
</head>
...
<body>
    <div id="background">
        ...
        <div id="statement">
            <h1>Dibuja el signo de mayor que:</h1>
        </div>
        ...
        <div id="finish">
            ...
            <br>
            <a id="continue" class="btn btn-primary disable-links" href="index.php?controlador=DyscalculiaIndex&accion=Graphic29" style="color: white;">Continuar</a>
        </div>
    </div>
    </div>
</body>
        ...
        document.querySelectorAll('button.answer').forEach(function(btn) {
            btn.addEventListener('click', function(e) {
                ...
                var answer11 = {
                    type: 0,
                    isCorrect: null,
                    answer: "Dibuja el signo de mayor que:",
                    image: imagen,
                    testName: "Prueba de discalculia gráfica 1 - 9 años"
                };
