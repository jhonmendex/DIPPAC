...
<head>
    ...
    <title>Prueba de discalculia verbal 2 - 9 años</title>
</head>
...
<body>
    <div id="background">
        ...
        <div id="operation">
            <div id="source">
                <audio id="audio" src="audios/VerbalTest2_9y_audio.mp3" preload="none" controls></audio>
            </div>
            ...
            <div id="buttons">
                <div id="finish">
                    <a id="continue" class="btn btn-primary disable-links" href="index.php?controlador=DyscalculiaIndex&accion=Graphic19">Continuar</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $(document).on('change', 'input', function(e) {
            ...
            var isCorrect = answer == "78+72" ? true : false;
