...
<head>
    ...
    <title>Prueba de discalculia gráfica 1 - 6 años</title>
</head>
...
<body>
    <div id="background">
        ...
        <div id="finish">
            ...
            <br>
            <a id="continue" class="btn btn-primary disable-links" href="index.php?controlador=DyscalculiaIndex&accion=Graphic26" style="color: white;">Continuar</a>
        </div>
    </div>
    </div>
</body>
