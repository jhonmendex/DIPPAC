...
<head>
    ...
    <title>Prueba de discalculia gráfica 1 - 8 años</title>
</head>
...
<body>
    <div id="background">
        ...
        <div id="finish">
            ...
            <br>
            <a id="continue" class="btn btn-primary disable-links" href="index.php?controlador=DyscalculiaIndex&accion=Graphic28" style="color: white;">Continuar</a>
        </div>
    </div>
    </div>
</body>
