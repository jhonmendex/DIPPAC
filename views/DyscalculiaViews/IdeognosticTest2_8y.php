...
<head>
    ...
    <title>Discalculia ideognostica - Prueba 2 - 8 años</title>
</head>
...
<body>
    <div id="background">
        ...
        <div id="operation">
            ...
            <div id="buttons">
                <div id="finish">
                    <a id="continue" class="btn btn-primary" href="index.php?controlador=DyscalculiaIndex&accion=Ideognostic29">Continuar</a>
                </div>
