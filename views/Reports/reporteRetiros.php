...
<div id="main">    
    <div class="maxcontent" id="content"> 
        <div id="fancybox-title" class="fancybox-title-float" style="display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Reporte de bajas/retiros</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>
        <div class="container" style="margin-bottom: 20px; margin-top: 10px">           
            <div style="width: 100%;">     
                <fieldset class="colorleyend" style="width: 97%; padding: 10px">
                    ...
                    <form method="POST" action="index.php?controlador=Reports&accion=reporteBajas"> 
                        <table border="0">   
                          <tr>   
                ...
                <div>           
                    <div style="margin-top: 0px;margin-bottom: 20px; width: 99%">   
                        <?php foreach ($reportebajas[0] as $key => $value) { ?>  
                            <fieldset class="colorleyend" style="width: 99%; padding: 5px">   
                                <legend class="colorleyendinto">Retiros de la bodega: <?php echo $reportebajas[0][$key]['nombrebodega']?></legend>       
                                      ...
                                      <div style="margin-top: 0px;margin-bottom: 20px">   
                                        <table class="mytable" border="0" cellspacing="0" cellpadding="0">      
                                            ...
                                            <tbody style="line-height: 25px">      
                                                <?php   
                                                foreach ($reportebajas[0][$key]['productos'] as $value3) {
                                                    $totales = $value3["total"]; 
                                                    ?>     
                                ...
                                <table class="table" cellspacing="0" cellpadding="3" border="0" style="margin-top: 40px; padding: 5px; font-size: 20px; line-height: 20px; width: 60% !important"> 
                                    <thead> 
                                        ...
                                        <tr class="class1">
                                            ...
                                            <th class="item" align="center" style="background-color: #f3f3f3"><?php echo '&#36;' . number_format($totales, 0, ',', '.'); ?></th>
