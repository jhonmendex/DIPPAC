...
<div id="main">    
    <div class="maxcontent" id="content"> 
        <div id="fancybox-title" class="fancybox-title-float" style="display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Reporte de ajuste de inventario</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>
        <div class="container" style="margin-bottom: 20px; margin-top: 10px">           
            <div style="width: 100%;">     
                <fieldset class="colorleyend" style="width: 97%; padding: 10px">
                    ...
                    <form method="POST" action="index.php?controlador=Reports&accion=reporteAjusteinv"> 
                        <table border="0">   
                          <tr>   
                ...
                <div>              
                    <div style="margin-top: 0px;margin-bottom: 20px; width: 99%">   
                        <?php foreach ($reporteajuste[0] as $key => $value) { ?>  
                            <fieldset class="colorleyend" style="width: 99%; padding: 5px">   
                                <legend class="colorleyendinto">Ventas de la bodega: <?php echo $reporteajuste[0][$key]['nombrebodega']?></legend>       
                                        ...
                                        <table class="mytable" border="0" cellspacing="0" cellpadding="0">      
                                            <thead>  
                                                <tr class="headall">     
                                                    ...
                                                    <th class="head">Cantidad ajustada:</th>
                                                    <th class="head">Valor ajustado</th>                 
                                                </tr>       
                                            </thead>        
                                            <tbody style="line-height: 25px">      
                                                <?php   
                                                foreach ($reporteajuste[0][$key]['productos'] as $value3) {
                                                    ?>     
                                                    <tr id="<?php echo $value3["id"] ?>">   
                                                        ...
                                                        <td style="text-align: center" class="item2">    
                                                          <?php if($value3['documento']=='AJU.INV.FIS.SA'){ ?> 
                                                            <strong style="color: #CC0000"><?php echo "-".$value3["cantidad"]; ?></strong><?php }
                                                            else { ?> <strong style="color: #369808"><?php echo "+".$value3["cantidad"]; ?></strong><?php } ?>  
                                                        </td>  
                                ...
                                <table class="table" cellspacing="0" cellpadding="3" border="0" style="margin-top: 40px; padding: 5px; font-size: 20px; line-height: 20px; width: 60% !important"> 
                                    <thead> 
                                        ...
                                        <tbody> 
                                        <tr class="class1"> 
                                            <th class="init" style="background-color: #D3D6FF">Total ajuste</th>
                                            <th class="item" align="center" style="background-color: #f3f3f3"><?php echo  '&#36;' .number_format($reporteajuste[1][$key], 0, ',', '.'); ?></th>
                                        </tr>                                        
                                        </tbody>
                                    </table> 
                            </fieldset>   
