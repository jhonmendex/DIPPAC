...
<div id="main">    
    <div class="maxcontent" id="content"> 
        <div id="fancybox-title" class="fancybox-title-float" style="display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Reporte de ventas</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>
        <div class="container" style="margin-bottom: 20px; margin-top: 10px">           
            <div style="width: 100%;">     
                <fieldset class="colorleyend" style="width: 97%; padding: 10px">
                    ...
                    <form method="POST" action="index.php?controlador=Reports&accion=reporteVentas2"> 
                        <table border="0">   
                          <tr>   
                            ...
                            <td>Usuarios:</td>
                                    <td>    
                                        ...
                                        <div style="margin-left: 1px;float: left; margin-top: 2px">   
                                            <a class="search" href="index.php?controlador=Reports&accion=getClientes" title="Buscar cliente">
                                            ...
                                            <thead>  
                                                <tr class="headall">     
                                                    ...
                                                    <th class="headinit" style="cursor: pointer;"># factura</th>
                                                     <th class="headinit" style="cursor: pointer;">nombre y apellidos cliente</th>
                                                    <th class="head">No. cédula</th>
                                                ...
                                                foreach ($reportev[0][$key]['productos'] as $value3) {
                                                    ...
                                                    <tr id="<?php echo $value3["id"] ?>">   
                                                        ...
                                                        <td style="text-align: center" class="item2">  
                                                            <?php echo $value3["usuario"] ?>   
                                                        </td> 
                                                        <td style="text-align: center" class="item2">  
                                                             <?php echo $value3["cedula"] ?>    
                                                        </td>
                                                        <td style="text-align: center" class="item2">  
                                                        ...
                                                        <td style="text-align: center" class="item2">   
                                                         <?php foreach ($reportev[3][$value3["id"]] as $value4){ 
                                                             $comparador;       
                                                             if($comparador !=$value4['ivas']){ 
                                                                 echo '&#36;' . number_format($value4['ivas'], 0, ',', '.');  
                                                        ...
                                                        <td style="text-align: center" class="item2">
                                                           <?php
                                                            $totalventa = $comparador+$value3["subtotal"];
