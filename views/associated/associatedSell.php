...
<div id="main"> 
    <div class="maxcontent" id="content"> 
        <div id="fancybox-title" class="fancybox-title-float" style="display: block; z-index: 50">
            <table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-main">Inscripci&oacute;n de estudiantes: Verificaci&oacute;n de los datos</td></tr></tbody></table></div>
        <div class="container" style="margin-bottom: 20px; margin-top: 10px">
            ...
            <table style="width: 100%;" border="0">
                ...
                <tr>
                    <td class="describ"><strong>Codigo de estudiante:</strong></td>
                    <td width="600" class="infodescrib">
                        <?php echo $usuario->getIdPadre() ?>
                    </td>
                </tr>
                <tr>
                    <td class="describ"><strong>Nombre del estudiante:</strong></td>
                    <td width="600" class="infodescrib">
