...
function validar(e) {
  if (e.keyCode == 86 && e.ctrlKey) return true;
    ...
    if (!$(this).attr("disabled")) {
      if ($(this).attr("presence")) {
        ...
        if (res == "ok") {
            ...
            if (res2 == "ok") {
              if ($(this).attr("norepeat")) {
                var res3 = unique(
                  ...
                  $(this).attr("label"),
                  $(this).attr("name"),
                  $(this).attr("except") ? $(this).attr("except") : null
                );
                if (res3 == "ok") {
                } else {
                  submitAct = false;
                  $(this).after(
                    '<div class="error_input" style="font-size: 12px; color: Red; font-weight: bold;">' +
                      res3 +
                      "</div>"
                  );
          ...
          submitAct = false;
          $(this).after(
            '<div class="error_input" style="margin-top:8px !important;font-size: 12px; color: Red; font-weight: bold;">' +
              res +
              "</div>"
          );
          $(this).css("background-color", "#F0CBBA");
